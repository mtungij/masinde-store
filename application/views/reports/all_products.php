            ...
            <table class="table-sorter table-sorter table-bordered-bottom table-hover border-collapse border border-slate-400">
              <thead>
                <tr>
                  ...
                  <th class="border border-slate-300 p-3">Total Quantity <br> (All Branches)</th>
                  <th class="border border-slate-300 p-3">Expire date</th>
                </tr>
              </thead>
              <tbody>
                <?php $rowId = 1 ?>
                ...
                <tr>
                  <td class="border border-slate-300 p-3"><?= $rowId < 10 ? "0".$rowId++ : $rowId++ ?></td>
                    ...
                    <td class="border border-slate-300 p-3"><?= format_prices($data->total_inventory) ?></td>
                    <td class="border border-slate-300 p-3"><?= date('d/m/Y', strtotime($data->expire_date)) ?></td>
                </tr>
                <?php endforeach ?>
              </tbody>
            </table>
