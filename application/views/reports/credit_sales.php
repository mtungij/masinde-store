  ...
  <main class="lg:flex">
    ...
    <div class="main-content flex-grow min-h-[100%] py-20 relative px-4 lg:pr-8 lg:pl-3">
      ...
      <div class="flex flex-row justify-between items-center pt-2 pb-6">
        <!-- Range time -->
      <?php echo form_open('reports/credit_sales_filter', ['class' => 'mb-6'])?>
      ...
      <div class="grid grid-cols-1 sm:gap-4 md:gap-6">
        ...
        <div class="px-6 py-8 flex flex-col rounded-xl bg-white dark:bg-gray-900">
          ...
          <div class="text-center">
            ...
            <h3 class="text-title-lg text-gray-700 dark:text-gray-300">CREDIT SALES REPORT</h3>
          ...
          <div class="relative overflow-auto scrollbars" style="white-space: nowrap">
            <table class="table-sorter table-sorter table-bordered-bottom table-hover border-collapse border border-slate-400">
              <thead>
                <tr>
                  <th class="border border-slate-300 p-3">Invoice Number</th>
                  <th class="border border-slate-300 p-3">Customer Name</th>
                  <th class="border border-slate-300 p-3">Staff</th>
                  <th class="border border-slate-300 p-3">From Branch</th>
                  <th class="border border-slate-300 p-3">Customer Phone</th>
                  <th class="border border-slate-300 p-3">Customer Address</th>
                  <th class="border border-slate-300 p-3">Total Credit</th>
                  <th class="border border-slate-300 p-3">Amount Paid</th>
                  <th class="border border-slate-300 p-3">Amount Due</th>
              ...
              <tbody>
                ...
                <tr>
                  <td class="border border-slate-300 p-3"><?= $data->order_number ?></td>
                    <td class="border border-slate-300 p-3"><?= $data->customer_name ?></td>
                    <td class="border border-slate-300 p-3"><?= $data->staff ?></td>
                    <td class="border border-slate-300 p-3"><?= $data->branch ?></td>
                    <td class="border border-slate-300 p-3"><?= $data->customer_phone ?></td>
                    <td class="border border-slate-300 p-3"><?= $data->customer_address ?></td>
                    <td class="border border-slate-300 p-3"><?= number_format($data->amount_due) . "/=" ?></td>
                    <td class="border border-slate-300 p-3"><?= number_format($data->amount_paid) . "/=" ?></td>
                    <td class="border border-slate-300 p-3"><?= number_format($data->amount_due - $data->amount_paid) . "/=" ?></td>
