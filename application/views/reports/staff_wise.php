  ...
  <main class="lg:flex">
    ...
    <div class="main-content flex-grow min-h-[100%] py-20 relative px-4 lg:pr-8 lg:pl-3">
      ...
      <div class="flex flex-row justify-between items-center pt-2 pb-6">
        <!-- Range time -->
      <?php echo form_open('reports/staff_wise_filter', ['class' => 'mb-6'])?>
      ...
      <div class="grid grid-cols-1 sm:gap-4 md:gap-6">
        ...
        <div class="px-6 py-8 flex flex-col rounded-xl bg-white dark:bg-gray-900">
          ...
          <div class="text-center">
            ...
            <h3 class="text-title-lg text-gray-700 dark:text-gray-300">STAFF WISE SALES REPORT</h3>
            ...
            <table class="border-collapse border border-slate-400">
              <thead>
                <tr>
                  ...
                  <th class="border border-slate-300 p-3">Username</th>
                  <th class="border border-slate-300 p-3">Position</th>
                  <th class="border border-slate-300 p-3">Total Seles</th>
                  <th class="border border-slate-300 p-3">Total Revenue(Tsh)</th>
                </tr>
              </thead>
              <tbody>
                <?php $rowId = 1 ?>
                ...
                <tr>
                  ...
                  <td class="border border-slate-300 p-3"><?= $data->username ?></td>
                  <td class="border border-slate-300 p-3"><?= $data->position ?></td>
                  <td class="border border-slate-300 p-3"><?= ($data->total_orders) ?></td>
                  <td class="border border-slate-300 p-3"><?= number_format($data->total_revenue) . "/=" ?></td>
                </tr>
                <?php endforeach ?>
              </tbody>
            </table>
